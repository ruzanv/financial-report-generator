...
from ..services.docx_generator import build_report
...
def generate_report_task(self, csv_path: str) -> str:
    """Celery task: validates upload, makes predictions, writes DOCX, returns filename."""
    try:
        ...
        build_report(df_prepared, preds, report_path)
